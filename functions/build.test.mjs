...
import { clean } from './partials/clean.mjs'
...
const fontPath = gulpConfig.get('srcPath') + '/fonts'

const imageContent = '<?xml version="1.0" encoding="UTF-8" standalone="no"?>\n' +
...
const imagePath = gulpConfig.get('srcPath') + '/img'
